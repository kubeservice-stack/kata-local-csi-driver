...
import (
	...
	"github.com/kubeservice-stack/kata-local-csi-driver/pkg/csi/lvm"
	"github.com/kubeservice-stack/kata-local-csi-driver/pkg/om"
...
const (
	...
	TypePluginSuffix = "plugin.csi.kubeservice.cn"

	// PluginServicePort default port is 12260.
	PluginServicePort = "12260"

	// ProvisionerServicePort default port is 12270.
	ProvisionerServicePort = "12270"

	// TypePluginLocal LVM type plugin
	TypePluginLocal = "local.csi.kubeservice.cn"
